...
## fit the binomial model from the first day (because bionmial has property of bounded and descrete)
...
summary(mod.seal1)
#Default transformation is logit here
...
#check out the data
summary(aphid2) 
#two treatments and counts of aphids. typical poisson data
dim(aphid2)
head(aphid2)
str(aphid2)
...
par(mfrow=c(2,2)); plot(mod1) 
windows()  #windows people, please use "windows()" here
...
#but proceed to check all of the other terms as well
